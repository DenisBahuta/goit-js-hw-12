import{S as b,i as d,a as g}from"./assets/vendor-990f3500.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&l(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerpolicy&&(r.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?r.credentials="include":e.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(e){if(e.ep)return;e.ep=!0;const r=i(e);fetch(e.href,r)}})();const f="/goit-js-hw-12/assets/octagon-8dac5379.svg",k=document.querySelector(".form"),c=document.querySelector(".gallery"),u=document.querySelector(".loader"),a=document.querySelector("#next-btn");let o=0,y=null;const h=new b(".gallery a",{captionsData:"alt",captionDelay:250}),L="https://pixabay.com/api",v=new URLSearchParams({key:"41838546-9d950a50e841202e6c289d2dd",image_type:"photo",orientation:"horizontal",safesearch:"true",per_page:40});k.addEventListener("submit",x);a.addEventListener("click",S);async function x(t){t.preventDefault();const s=t.currentTarget.elements.input.value;if(y=s,o=1,a.classList.add("is-hidden"),c.innerHTML="",!s.trim()){d.show({title:"❕",theme:"light",message:"Please, fill in the search field",messageSize:"20px",messageColor:"#808080",backgroundColor:"#e7fc44",position:"topRight",timeout:3e3});return}u.classList.remove("is-hidden"),t.currentTarget.reset();try{const i=await C(s);if(i.hits.length===0){d.show({iconUrl:f,theme:"dark",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16px",messageColor:"white",backgroundColor:"#EF4040",position:"topRight",timeout:5e3});return}c.insertAdjacentHTML("beforeend",p(i.hits)),h.refresh(),a.classList.remove("is-hidden"),m()}catch(i){w(i)}finally{u.classList.add("is-hidden")}}async function C(t){try{return(await g.get(`${L}/?${v}&q=${t}&page=${o}`)).data}catch(s){throw new Error(s)}}function p(t){return t.map(({webformatURL:s,largeImageURL:i,tags:l,likes:e,views:r,comments:n,downloads:$})=>`<li class="gallery-item">
